...
f = ROOT.TFile('hist-no-filtering-narrow-epl.root')
d = f.Get('MAC2')
...
with open ('narrow-epl-cellstats.csv', 'w') as file, tqdm(total=max_uv*max_uv*max_layer) as t:
